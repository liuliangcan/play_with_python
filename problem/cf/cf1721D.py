...
考虑第二位，不破坏上一位的前提下，刚才的组只能组内对应，即a00对应b01,a01对应b00，因此分成4组(a00,b01),(a01,b00),(a10,b11),(a11,b10)
考虑第三位，同理分8组(a000,b011),(a001,b010),,(a010,b001),(a011,b000),,(a100,b111),(a101,b110),,(a110,b101),(a111,b100)
..
...
因此这里状态是指q数组本身的整体状态：并非队列中存多个状态，而是队列本身整体是一个状态。
